...
from visulize.point2cam import point2cam_label
...
class LightningBaseModel(pl.LightningModule):
    ...
    def test_step(self, data_dict, batch_idx):
        ...
        colors_map = [( 0, 0,  0), (100, 150, 245), (254, 230, 100), (150, 60, 30), (180, 30, 80), (250, 80, 100), 
        ...
        image = data_dict['img'] # [B, 3, 320,480]
        B, C, H, W = image.shape
        ...
        # seg_img =  np.reshape(np.array(colors_map, np.uint8)[np.reshape(pr, [-1])], [H, W, -1])
        ...
        # gt_img = Image.blend(old_img, gt_img, 1)          
